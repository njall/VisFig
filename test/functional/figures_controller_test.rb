...
class FiguresControllerTest < ActionController::TestCase
  ...
  test "should create figure" do
    assert_difference('Figure.count') do
      post :create, figure: { columnHeadings: @figure.columnHeadings, dataSet: @figure.dataSet, doi: @figure.doi, title: @figure.title }
    end
  ...
  test "should update figure" do
    put :update, id: @figure, figure: { columnHeadings: @figure.columnHeadings, dataSet: @figure.dataSet, doi: @figure.doi, title: @figure.title }
    assert_redirected_to figure_path(assigns(:figure))
  end

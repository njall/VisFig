...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { dataset: @datum.dataset, figshare_url: @datum.figshare_url, uploader: @datum.uploader }
    end
  ...
  test "should update datum" do
    put :update, id: @datum, datum: { dataset: @datum.dataset, figshare_url: @datum.figshare_url, uploader: @datum.uploader }
    assert_redirected_to datum_path(assigns(:datum))
  end
